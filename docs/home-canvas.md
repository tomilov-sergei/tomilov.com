...
- внутренняя плоскость примерно 3200 x 2200 px на desktop;
- центр находится в середине плоскости;
- у каждой темы есть угол, цвет и мягкая кривая от центра;
- возраст материала управляет расстоянием от центра: новое ближе, старое дальше;
- небольшой детерминированный сдвиг не дает карточкам лечь механической дугой;
- карточки могут немного накладываться друг на друга;
...
- клики по карточкам открывают постоянные страницы;
